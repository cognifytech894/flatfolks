...
export async function generateMetadata({ searchParams }: { searchParams: Promise<SearchParams> }): Promise<Metadata> {
  ...
  const title = filters.location ? `Sharing Flat in ${filters.location} | Rooms for Rent` : "Find Rooms and Flatmates Near You";
  const description = filters.location
    ? `Looking for a sharing flat in ${filters.location}? Browse verified rooms and flats for rent, filter by budget, property type, and amenities on FlatFolks.`
