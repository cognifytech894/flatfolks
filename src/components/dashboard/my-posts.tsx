...
type Post = { id: string; title: string; description?: string; location: string; rent: number; propertyType: string; listingKind?: "flat-offer" | "flat-requirement"; availableFrom?: string; genderPreference?: "Male" | "Female" | "Family" | "Any"; tags: string[]; images?: string[]; contactPhone?: string; bedrooms?: number; bathrooms?: number; preferences?: string[] };
