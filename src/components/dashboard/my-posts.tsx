...
type Post = { id: string; title: string; description?: string; location: string; rent: number; propertyType: string; listingKind?: "flat-offer" | "flat-requirement"; availableFrom?: string; genderPreference?: "Boy" | "Girl" | "Any"; tags: string[]; images?: string[]; contactPhone?: string };
